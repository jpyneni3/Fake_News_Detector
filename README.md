...
Examples:
Augementation Data/semi cleaned/LIAR.csv --> LIAR dataset semi cleaned to run Data Augementation on
Augementation Data/LIAR_SR.csv --> Output of running Synonym Replacement on semi cleaned LIAR dataset
Augementation Data/LIAR_SR_clean.csv --> Aggressively cleaned Synonym Replacement output from LIAR dataset
